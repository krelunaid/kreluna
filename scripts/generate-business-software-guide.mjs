...
function buildPage(language, article) {
  ...
  const schema = {
    ...
    "@graph": [
      ...
      { "@type": "Service", "@id": `${canonical}#service`, name: "Kreluna Marketplace", provider: { "@id": `${siteUrl}/#organization` }, areaServed: "Worldwide", url: `${siteUrl}/marketplace` },
