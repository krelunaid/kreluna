...
<header className="site-header localized-header"><a className="brand" href={prefix}><img src="/kreluna-logo-64.webp" width="34" height="34" alt="" /><span>KRELUNA</span></a><nav className="desktop-nav" aria-label={access[1]}><a href="#services">{t.services}</a><a href={`${prefix}/projects`}>{t.projects}</a><a href={`${prefix}/citybeam`}>CityBeam</a><a className="nav-cosmora" href={`${prefix}/cosmora`}>Cosmora</a></nav><a className="button button-small button-primary" href={contact}>{t.contact}</a></header>
