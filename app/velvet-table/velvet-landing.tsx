...
export default function VelvetLanding({ locale }: { locale: VelvetLocale }) {
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      { "@type": "WebPage", "@id": `${pageUrl}#webpage`, url: pageUrl, name: copy.title, description, inLanguage: copy.locale, isPartOf: { "@id": `${siteUrl}/#website` }, about: { "@id": `${pageUrl}#service` }, primaryImageOfPage: { "@type": "ImageObject", url: `${siteUrl}/velvet-table/hero.jpg`, width: 1600, height: 1067 }, dateModified: "2026-08-23" },
