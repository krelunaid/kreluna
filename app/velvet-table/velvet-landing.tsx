...
export default function VelvetLanding({ locale }: { locale: VelvetLocale }) {
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      { "@type": "Service", "@id": `${pageUrl}#service`, name: "Velvet Table", alternateName: "Velvet Table by Kreluna", serviceType: copy.serviceType, description: copy.description, provider: { "@id": `${siteUrl}/#organization` }, url: pageUrl, areaServed: "Worldwide", availableLanguage: Object.values(velvetCopy).map((item) => item.locale), audience: { "@type": "Audience", audienceType: copy.audience } },
